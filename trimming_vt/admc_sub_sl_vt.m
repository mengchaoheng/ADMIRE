function [x0t,u0t,y0t,dx0t] = admc_sub_sl_vt(Mach,Alt,x00,u00,AoA)
...
ct = [g Mass Vt Beta P Q R Psi Phi X Y Z dle fas frp Mach];
...
[vt_out,fval,exitflag,out] = fminsearch('admc_cost_sl_vt',vt,options);
if(~exitflag)
