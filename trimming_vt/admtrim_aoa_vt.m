% Filename admtrim_aoa_vt.m
% ADMIRE 3.4e trimming including speed control.
% Adapted from ADMIRE r3.4d Trimming start script.
...
[x0c,u0c,y0c,dx0c] = admc_sub_aoa_vt(Mach,Alt,x00,u00,Alpha);
...
elseif abs(dx0bare(1)) > 0.1
   fprintf('Warning: not able to maintain speed at specified condition. You probably do not have\na trimmed condition at all.\nTry changing your COST calculation in admc_cost_aoa.m');
else
