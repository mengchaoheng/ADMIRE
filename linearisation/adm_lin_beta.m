...
% Sideslip_command_cl is a 1x1 SiSo system 
% For making a Nichols plot for the Worst Case Stabilty margin, simply use the MATLAB command 'nichols' like:
% [gain,phase,wrad] = nichols(-Sideslip_command_cl,logspace(..,..,..)); etc, etc...

Sideslip_command_cl = connect(SYS0,[[1,2,4:31]',[1,2,4:31]'],3,3);
