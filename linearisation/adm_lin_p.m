...
% Rollrate_command_cl is a 1x1 SiSo system 
% For making a Nichols plot for the Worst Case Stabilty margin, simply use the MATLAB command 'nichols' like:
% [gain,phase,wrad] = nichols(-Rollrate_command_cl,logspace(..,..,..)); etc, etc...

Rollrate_command_cl = connect(SYS0,[[2:31]',[2:31]'],1,1);
